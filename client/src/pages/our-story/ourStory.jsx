      ...
      <Box sx={{ marginBottom: "200px" }}>
        ...
        >
          ...
          >
            ...
            >
              Our creations feature intricate appliqué, embroidery, hand
              beadwork, cutwork, and hand-painted details. Made with pure,
              eco-friendly fabrics, we prioritise sustainability and embrace the
              ethos of slow fashion with made-to-order designs that minimise
              waste.
              <Box sx={{ marginTop: 2 }} />
              At the heart of The Label 39 lies a passion for Indian
              craftsmanship, reimagined with a contemporary flair. Each
              silhouette is thoughtfully designed to offer comfort, grace, and a
              story of artistry. We are proud to present a brand that values
              authenticity, sustainability, and the effortless charm of the
              modern woman.
            </Typography>
          </Box>
        </Container>
